    ...
    describe('DeliveryOrder Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/delivery-orders';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a DeliveryOrder', () => {
                service.create(new DeliveryOrder(null)).subscribe(received => {
            ...
            it('should update a DeliveryOrder', () => {
                service.update(new DeliveryOrder(123)).subscribe(received => {
            ...
            it('should return a DeliveryOrder', () => {
            ...
            it('should return a list of DeliveryOrder', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new DeliveryOrder(123)]);
            });
