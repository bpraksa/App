...
describe('Service Tests', () => {
    describe('DeliveryOrderItem Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DeliveryOrderItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/delivery-order-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a DeliveryOrderItem', () => {
                service.create(new DeliveryOrderItem(null)).subscribe(received => {
            ...
            it('should update a DeliveryOrderItem', () => {
                service.update(new DeliveryOrderItem(123)).subscribe(received => {
            ...
            it('should return a DeliveryOrderItem', () => {
            ...
            it('should return a list of DeliveryOrderItem', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new DeliveryOrderItem(123)]);
            });
